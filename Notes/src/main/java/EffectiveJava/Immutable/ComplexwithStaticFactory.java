...
public final class ComplexwithStaticFactory {

    // Instance fields are declared private and final
    private final double realPart;
    private final double imaginaryPart;

    private ComplexwithStaticFactory(double realPart, double imaginaryPart) {
        this.realPart = realPart;
        this.imaginaryPart = imaginaryPart;
    }

    public static ComplexwithStaticFactory valueOf(double realPart, double imaginaryPart) {
        return new ComplexwithStaticFactory(realPart, imaginaryPart);
    }
