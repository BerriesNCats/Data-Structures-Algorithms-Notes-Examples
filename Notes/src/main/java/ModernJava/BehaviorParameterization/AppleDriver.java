...
public class AppleDriver {
    ...
    public static void main(String... args) {
        ...
        // Filter apples in inventory using the predicate method isGreenApple that takes in an Apple through the
        // filterApples method that takes in a List<Apple> (inventory) and a Predicate<Apple> (isGreenApple)
